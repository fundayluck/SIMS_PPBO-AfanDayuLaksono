...
import { useLazyGetProfileQuery, useLazyUpdateProfileQuery } from '../services/modules/profile'
    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center mt-10'>
                ...
                <div onClick={() => console.log('klik')} className={`bg-white fixed ml-[50px] ${update ? 'mb-[210px]' : 'mb-[250px]'} border border-gray border-1 rounded-full z-10 hover:cursor-pointer`}>
